...
# def main():
    # List of coin_ids
    coin_list = [
    'aevo-exchange','altlayer','apecoin','book-of-meme','bouncebit','civic','cookie',
    'digibyte','dogwifcoin','dymension','ethena','ether-fi','everipedia','first-digital-usd',
    'io','layerzero','lista','nervos-network','notcoin','omni-network','ong','pivx',
    'pixels','portal-2','renzo','saga-2','starknet','tensor','true-usd','vechain','wormhole',
    'zksync'
    ]
