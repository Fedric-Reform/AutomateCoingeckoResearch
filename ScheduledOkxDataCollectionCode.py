...
def main():
    # List of coin_ids
    coin_list = [
    'aethir','aevo-exchange','apecoin','book-of-meme',
'cat-in-a-dogs-world','civic','degen-base','digibyte',
'dogwifcoin','ecomi','ether-fi','everipedia','foxy',
'galatasaray-fan-token','ice','layerzero','matr1x',
'merlin-chain','notcoin','parcl','pixels','polyhedra-network',
'qna3-ai','realio-network','rsic-genesis-rune','safe',
'slerf','starknet','tensor','ultiverse','venom','wormhole',
'zentry','zerolend','zetachain','zeus-network','zksync'
]
    ...
    output_file = f"OkxData{datetime.now().strftime('%Y%m%d')}.xlsx"
