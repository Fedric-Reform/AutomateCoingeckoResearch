...
def main():
    # List of coin_ids
    coin_list = [
        'aark-digital', 'aether-games', 'aethir', 'aevo-exchange', 'altlayer',
        'apeironnft', 'aperture-finance', 'aurora-near', 'aurory', 'based-brett',
        'beoble', 'bitbrawl', 'bitscrunch-token', 'blast', 'blockgames',
        'bonusblock', 'book-of-meme', 'bouncebit', 'cat-in-a-dogs-world',
        'clearpool', 'cookie', 'degen-base', 'dogwifcoin', 'drift-protocol',
        'eesee', 'elixir-token', 'entangle', 'ether-fi', 'fluence-2',
        'foxy', 'gaimin', 'galaxis-token', 'gam3s-gg', 'heroes-of-mavia',
        'holograph', 'htx-dao', 'imaginary-ones', 'io', 'kamino',
        'layerzero', 'lifeform', 'masa-finance', 'merlin-starter', 'mfercoin',
        'mog-coin', 'mon-protocol', 'nakamoto-games', 'neuron', 'nibiru',
        'notcoin', 'omni-network', 'parcl', 'planet-mojo', 'playbux',
        'polyhedra-network', 'ponke', 'popcat', 'portal-2', 'pundi-x-purse',
        'qorpo-world', 'scallop-2', 'slash-vision-labs', 'spectral', 'starheroes',
        'starknet', 'subquery-network', 'taiko', 'tars-protocol', 'teleport-system-token',
        'tensor', 'thetanuts-finance', 'ultiverse', 'venom', 'wen-4',
        'wormhole', 'wrapped-eeth', 'xzk', 'zentry', 'zerolend',
        'zklend-2', 'zksync'
    ]
    ...
    output_file = f"BybitData{datetime.now().strftime('%Y%m%d')}.xlsx"
